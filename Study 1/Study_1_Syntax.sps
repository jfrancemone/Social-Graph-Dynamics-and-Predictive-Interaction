...
RECODE cond (1=1) (2=0) (3=1) (4=0) INTO A_Bad_Good.
RECODE cond (1=0) (2=0) (3=1) (4=1) INTO C_Present.
RECODE cond (1=SYSMIS) (2=SYSMIS) (3=1) (4=0) INTO C_Bad_Good_Binary.
EXECUTE.
...
IF(C_Present=1) missing_data = nmiss(
A_Bad_Good, C_Present, Attent_Chk_1, Attent_Chk_2,
...
IF(C_Present=0) missing_data = nmiss(
A_Bad_Good, C_Present, Attent_Chk_1, Attent_Chk_2,
cmfq_care_1_r_A, cmfq_care_3_r_A, cmfq_care_4_r_A, cmfq_care_5_r_A,
cmfq_fair_1_r_A, cmfq_fair_2_r_A, cmfq_fair_3_r_A, cmfq_fair_5_A,
cmfq_loy_2_r_A, cmfq_loy_3_r_A, cmfq_loy_4_A, cmfq_loy_6_r_A, 
...
*Final N =162 -- 100 Participants Dropped*

**Veryify Random Assignment**

USE ALL.
CROSSTABS
  /TABLES=A_Bad_Good BY C_Present BY filter_final
...
**Additional C Filter for Model Tests**
    
COMPUTE filter_final_C=(filter_final=1 & C_Present =1).
VALUE LABELS filter_final_C 0 'Not Selected' 1 'Selected'.
FORMATS filter_final_C (f1.0).
EXECUTE.

FREQUENCIES filter_final_C.
EXECUTE.
...
GLM DISPO_A Protag_A Antag_A DISPO_B Protag_B Antag_B BY A_Bad_Good C_Present
  /METHOD=SSTYPE(3)
  /INTERCEPT=INCLUDE
  /PLOT=PROFILE(A_Bad_Good*C_Present) TYPE=LINE ERRORBAR=CI MEANREFERENCE=NO YAXIS=AUTO
  /EMMEANS=TABLES(OVERALL) 
  /EMMEANS=TABLES(A_Bad_Good) COMPARE ADJ(BONFERRONI)
  /EMMEANS=TABLES(C_Present) COMPARE ADJ(BONFERRONI)
  /EMMEANS=TABLES(A_Bad_Good*C_Present) COMPARE(A_Bad_Good) ADJ(BONFERRONI)
  /EMMEANS=TABLES(A_Bad_Good*C_Present) COMPARE(C_Present) ADJ(BONFERRONI)
  /PRINT=DESCRIPTIVE ETASQ HOMOGENEITY
  /CRITERIA=ALPHA(.05)
  /DESIGN= A_Bad_Good C_Present A_Bad_Good*C_Present.

**Character C**

FILTER BY filter_final_C.
...
GLM WARMTH_A COMPET_A WARMTH_B COMPET_B BY A_Bad_Good C_Present
  /METHOD=SSTYPE(3)
  /INTERCEPT=INCLUDE
  /PLOT=PROFILE(A_Bad_Good*C_Present) TYPE=LINE ERRORBAR=CI MEANREFERENCE=NO YAXIS=AUTO
  /EMMEANS=TABLES(OVERALL) 
